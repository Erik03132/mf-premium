                            ...
                            >
                                <div className="flex flex-col md:flex-row gap-8">
                                    <div className="flex-1">
                                        ...
                                        <div className="markdown-content text-white/60 line-clamp-3 overflow-hidden">
                                    ...
                                    <div className="flex items-center">
                                        <Link 
                                            ...
                                            className="size-14 rounded-2xl bg-sapphire/20 border border-sapphire/30 flex items-center justify-center group-hover:bg-sapphire group-hover:border-sapphire transition-all group-hover:scale-110 active:scale-95"
                                        >
                                            <ArrowRight className="size-6 text-sapphire group-hover:text-white transition-colors" />
                                        </Link>
                                    </div>
                                </div>
                            </motion.div>
